/* =========================================================
   MAHARA BPO
   SIMPLE BILINGUAL WEBSITE SCRIPT
   English + Arabic
   ========================================================= */
...
const translations = {
  en: {
    ...
    "hero.eyebrow": "Premium Modern Contact Center",
    "hero.heading":
    ...
    "hero.trust1": "Dedicated Teams",
    "hero.trust2": "Advanced Technology",
    "hero.trust3": "Scalable Operations",
    "hero.cardLabel": "Your Customer Experience Partner",
    "hero.cardTitle": "People. Process. Technology.",
    "hero.cardText":
      "A modern operating model built around your customers, your brand and your business goals.",

    "value.eyebrow": "Why Us",
    "value.heading": "We Do More Than Manage Customer Service.",
    "value.lead":
      "We build complete customer experience operations designed around the way your business works.",
    "value.card1.title": "Better Experience",
    "value.card1.text":
      "Professional and consistent communication across every customer touchpoint.",
    "value.card2.title": "Higher Efficiency",
    "value.card2.text":
      "Structured operations that help improve productivity and reduce operational waste.",
    "value.card3.title": "Scalable Growth",
    "value.card3.text":
    ...
    "services.learn": "Explore Solution →",

    "services.card1.title": "Customer Service",
    "services.card1.text":
      "Professional customer communication across the channels your customers use every day.",
    "services.card2.title": "Contact Center",
    "services.card2.text":
    ...
    "experience.cta": "Discover How We Work",

    "testimonial.eyebrow": "Partnership",
    "testimonial.heading": "Partnerships Built Around Results",
    "testimonial.text":
    ...
    "testimonial.label": "The MAHARA BPO Approach",

    "final.eyebrow": "Let's Build Better",
    "final.heading":
      "Ready to Elevate Your Customer Experience?",
    "final.text":
      "Tell us what your business needs and let us explore the right operating model for you.",
    "final.button": "Talk to Our Team",

    "quote.eyebrow": "Request a Quote",
    "quote.heading": "Tell Us What Your Customers Need.",
    "quote.description":
      "We will design a support model around your business requirements, customer journey and growth objectives.",
    "quote.point1": "Dedicated support teams",
    "quote.point2": "Flexible operating models",
    "quote.point3": "Multi-channel support",
    ...
    "form.optionServiceCustomer": "Customer Service",
    "form.optionServiceContact": "Contact Center",
    "form.optionServiceTechnical": "Technical Support",
    ...
    "form.whatsapp": "WhatsApp Inquiry",

    "form.message.required":
      "Please complete all required fields correctly.",
    "form.message.email":
      "Your email application will open so you can send your inquiry to Info@MaharaBPO.com.",
  ...
  ar: {
    ...
    "hero.eyebrow": "مركز عمليات متطور",
    "hero.heading":
    ...
    "hero.ctaSecondary": "اكتشف حلولنا",
    "hero.trust1": "فرق متخصصة",
    "hero.trust2": "تقنيات متقدمة",
    "hero.trust3": "عمليات قابلة للتوسع",
    "hero.cardLabel": "شريكك في تجربة العملاء",
    "hero.cardTitle": "الإنسان. العملية. التقنية.",
    "hero.cardText":
      "نموذج تشغيلي حديث مصمم حول عملائك وعلامتك التجارية وأهداف أعمالك.",

    "value.eyebrow": "لماذا نحن",
    "value.heading":
    ...
    "technology.cta": "تحدث مع فريقنا ←",
    "technology.card1.title": "تكامل الأنظمة",
    "technology.card1.text":
      "ربط عمليات خدمة العملاء بالأدوات والأنظمة التي تستخدمها أعمالك.",
    "technology.card2.title": "الأتمتة الذكية",
    "technology.card2.text":
      "تقليل المهام المتكررة وتحسين سرعة الاستجابة.",
    "technology.card3.title": "وضوح مؤشرات الأداء",
    "technology.card3.text":
      "رؤية أوضح لأداء الخدمة والنتائج التشغيلية.",
    "technology.card4.title": "دعم متعدد القنوات",
    "technology.card4.text":
    ...
    "experience.cta": "اكتشف كيف نعمل",

    "testimonial.eyebrow": "الشراكة",
    "testimonial.heading": "شراكات تُبنى حول النتائج",
    "testimonial.text":
      "لا نقيس النجاح بعدد التفاعلات التي نديرها فقط، بل بالقيمة التي نضيفها إلى أعمال عملائنا.",
    "testimonial.label": "منهج مهارة BPO",

    "final.eyebrow": "نبني نتائج أفضل",
    "final.heading":
      "هل أنت مستعد للارتقاء بتجربة عملائك؟",
    "final.text":
      "أخبرنا باحتياجات أعمالك، ودعنا نستكشف معًا النموذج التشغيلي المناسب لك.",
    "final.button": "تحدث مع فريقنا",

    "quote.eyebrow": "اطلب عرضًا",
    "quote.heading": "أخبرنا باحتياجات عملائك.",
    "quote.description":
      "سنصمم نموذج دعم يتوافق مع متطلبات أعمالك ورحلة العميل وأهداف النمو.",
    "quote.point1": "فرق دعم متخصصة",
    "quote.point2": "نماذج تشغيل مرنة",
    "quote.point3": "دعم متعدد القنوات",
    ...
    "form.fullNamePlaceholder": "أدخل الاسم الكامل",
    "form.companyNamePlaceholder": "أدخل اسم الشركة",
    "form.countryPlaceholder": "أدخل الدولة",
    "form.businessEmailPlaceholder":
      "أدخل البريد الإلكتروني للعمل",
    "form.phonePlaceholder":
      "أدخل رقم الهاتف أو واتساب",
    "form.industryPlaceholder": "أدخل مجال العمل",
    "form.additionalInfoPlaceholder":
      "أخبرنا عن أهدافك وحجم العملاء ونموذج الدعم المفضل لديك.",
    ...
    "form.optionServiceCustomer": "خدمة العملاء",
    "form.optionServiceContact": "مركز الاتصال",
    "form.optionServiceTechnical": "الدعم الفني",
    "form.optionServiceWhatsApp":
      "الدعم عبر واتساب والدردشة",
    "form.optionServiceEmail": "دعم البريد الإلكتروني",
    "form.optionServiceFollowUp": "متابعة العملاء",
    "form.optionServiceAppointments": "حجز المواعيد",
    "form.optionServiceOther": "أخرى",

    "form.optionHoursBusiness": "ساعات العمل الرسمية",
    "form.optionHoursExtended": "ساعات عمل ممتدة",
    "form.optionHours24Seven": "24/7",

    "form.submit": "اطلب عرضًا",
    "form.whatsapp": "إرسال الاستفسار عبر واتساب",
...
let currentLanguage =
  localStorage.getItem("maharaLanguage") || "en";
...
function setLanguage(language) {
  ...
  if (whatsapp) {
    whatsapp.setAttribute(
      "aria-label",
      translations[language]["aria.whatsapp"]
    );
  ...
  localStorage.setItem("maharaLanguage", language);
}
...
function getFormData(form) {
  ...
  return {
    ...
    businessEmail: data.get("businessEmail")?.trim() || "",
    phone: data.get("phone")?.trim() || "",
    industry: data.get("industry")?.trim() || "",
    agentsRequired: data.get("agentsRequired")?.trim() || "",
    languagesRequired: data.get("languagesRequired")?.trim() || "",
    servicesRequired: data.get("servicesRequired")?.trim() || "",
    workingHours: data.get("workingHours")?.trim() || "",
...
function createEmailBody(data) {
  if (currentLanguage === "ar") {
    return [
      ...
      `معلومات إضافية: ${data.additionalInfo || "لا توجد"}`
    ].join("\n");
  }
...
function setupForm() {
  ...
  form.addEventListener("submit", (event) => {
    ...
    if (!validateForm(form)) {
      showMessage("form.message.required");
    ...
    showMessage("form.message.email");
  });


  // WhatsApp button
  const whatsappButton =
    document.getElementById("whatsappQuoteBtn");
  ...
  if (whatsappButton) {
    whatsappButton.addEventListener("click", () => {
      ...
      showMessage("form.message.whatsapp");
    });
  }


  // Remove errors when user edits
  form
...
/*
   The logo must be in the SAME folder as index.html:
   ...
   This function automatically fixes old paths
   such as ./assets/mahra-logo1.png.
*/
...
function fixLogoPaths() {
  document.querySelectorAll("img, link").forEach((element) => {
    ...
    if (
      value &&
      value.includes("mahra-logo1.png")
    ) {
...
/* =========================================================
   FIX LOGO AGAIN AFTER PAGE LOAD
   ========================================================= */
